...
# make and test connection to the database
features_file = "../db/derived_features_list.txt"
connection = sqlite3.connect('../db/cadence_comparison.db')
cursor = connection.cursor()
...
aCadence.unique_source_ids.size
...
training_sets = ("synthetic_train","hipparcos_train")
...
## retreive test
testing_sets = ("synthetic_test","hipparcos_test")
